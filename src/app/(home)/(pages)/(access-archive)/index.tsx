  ...
  return (
    ...
    >
      <div className="flex flex-col-reverse sm:flex-col gap-6">
        <AnimatedHeading className="w-full sm:w-1/2 text-lg sm:text-[22px] capitalize sm:order-1">
        ...
        <Image
          ...
          width={779}
          height={265}
          className="sm:order-2 mb-8 w-full sm:mb-0 sm:w-[479px] md:w-[579px] lg:w-[779px]"
        />
      </div>
      <NavigateButton
        href="/acesso"
        className="w-full sm:w-[144px] cursor-pointer"
        onClick={handleClick}
      >
        Entrar
      </NavigateButton>
