      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-x-[5rem] gap-y-[1rem] ">
        <div className="p-5 rounded-2xl border-2 border-green-500">
          ...
          <div className="text-green-500 mt-3 max-w-md mx-auto text-base sm:text-lg md:mt-5 md:text-xl md:max-w-3xl min-w-[20rem]">
            <p>
              Somos os povos quilombolas das comunidades de Vila Santa Efigênia,
              Embaúbas, Crasto e Engenho Queimado, localizadas próximas a
              Furquim, distrito de Mariana, Minas Gerais.
            </p>
            <p>
              Juntos, formamos a Associação Quilombola Vila Santa Efigênia e
              Adjacências, criada em 2019. A associação desempenha um papel
