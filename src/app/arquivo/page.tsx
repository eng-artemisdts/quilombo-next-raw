...
const ArquivoPage: React.FC = () => {
  return (
    ...
    >
      <a className="w-[654px] h-[67px] rounded-full bg-red-rgba cursor-pointer text-white text-[25px] font-bold flex items-center justify-center gap-2 hover:opacity-80 transition-opacity duration-300">
