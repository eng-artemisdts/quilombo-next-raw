...
export default function ArquivoPage() {
  return (
    <div className="flex flex-col  bg-[url('/assets/tecido-chita-tecido-chita-chitao.jpg')] bg-cover bg-center items-center">
      <div className="fixed inset-0 bg-yellow-500/86 h-auto"  />
      <div className="z-10 flex flex-col max-w-7xl py-30 gap-20 ">
        <div className="flex flex-col md:flex-row gap-8 justify-center">
          <div className="border-2 border-green-500 rounded-2xl md:w-2/3 w-full p-8 text-green-500">
            ...
            <div className="flex flex-col text-d-s font-normal gap-6 pb-8">
              <p>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="border-2 border-green-500 rounded-2xl md:w-2/3 w-full p-8 text-green-500">
            ...
            <div>
              <ul className="list-disc list-inside text-d-s font-normal pl-6 pb-6 space-y-6 ">
                <li>
            ...
            <div>
              ...
              <div className="flex flex-col gap text-d-s font-normal gap-8">
                <p>
